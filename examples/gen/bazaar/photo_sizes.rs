...
impl IsDao for PhotoSizes{
    ...
    fn to_dao(&self)->Dao{
        ...
        match self.width{
            Some(ref _value) => dao.set("width", _value),
            None => dao.set_null("width")
        }
        match self.height{
            Some(ref _value) => dao.set("height", _value),
            None => dao.set_null("height")
        }
        match self.data{
        ...
        dao.set("photo_size_id", &self.photo_size_id);
        dao
    }
}
