...
pub fn organization_id()->Column{
    Column {
        table: Some(table::photo_sizes.to_owned()),
...
pub fn data()->Column{
    Column {
        ...
        is_primary: false, is_unique: false, not_null: false, is_inherited: false,
        default: None,
        comment: Some(r#"The base64 encoding of this photo, optimized to this size"#.to_owned()),
        foreign: None,
    }
}
