...
pub fn organization_id()->Column{
    Column {
        table: Some(table::product_availability.to_owned()),
...
pub fn always_available()->Column{
    Column {
        table: Some(table::product_availability.to_owned()),
...
pub fn available_day()->Column{
    Column {
        ...
        is_primary: false, is_unique: false, not_null: false, is_inherited: false,
        default: None,
        comment: Some(r#"{"Mon", "Tue", "Wed", "Thur", "Fri", "Sat", "Sun"}"#.to_owned()),
        foreign: None,
    }
}

pub fn open_time()->Column{
    Column {
        table: Some(table::product_availability.to_owned()),
