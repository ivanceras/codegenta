...
impl IsDao for Address{
    ...
    fn to_dao(&self)->Dao{
        ...
        dao.set("address_id", &self.address_id);
        match self.latitude{
            Some(ref _value) => dao.set("latitude", _value),
            None => dao.set_null("latitude")
        }
        match self.longitude{
            Some(ref _value) => dao.set("longitude", _value),
            None => dao.set_null("longitude")
        }
        match self.distance{
            Some(ref _value) => dao.set("distance", _value),
