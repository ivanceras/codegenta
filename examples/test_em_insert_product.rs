...
let pool = ManagedPool::init("postgres://postgres:p0stgr3s@localhost/bazaar_v7",1).unwrap();
    ...
    let product = Product{
            ...
            tags: Some(Json::I64(1)), //Some(Json::String("glass".to_owned())),
            info: Some(Json::I64(1)),//Some(Json::String("transparent glass chair".to_owned())),
            seq_no: Some(10),
            upfront_fee: Some(0.00),
            barcode: Some("10101010".to_owned()),
